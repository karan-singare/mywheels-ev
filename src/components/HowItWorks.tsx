const steps = [
  { num: 1, title: "Register", desc: "Contact us or walk in to get started." },
  { num: 2, title: "KYC Verification", desc: "Submit ID for approval." },
  { num: 3, title: "Choose Your Plan", desc: "Weekly, monthly, or long-term subscription." },
  { num: 4, title: "Vehicle Allocation", desc: "Collect vehicle from our location." },
  { num: 5, title: "Start Earning", desc: "Begin work immediately with reduced costs." },
];

const HowItWorks: React.FC = () => {
  return (
    <div className="relative">
      <div className="grid md:grid-cols-5 gap-8 md:gap-6 items-stretch">
        {steps.map((step, i) => (
          <div key={step.num} className="relative flex flex-col">
            {i < steps.length - 1 && (
              <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-gradient-to-r from-primary/60 to-primary/20 z-0" style={{ width: "calc(100% + 1rem)" }} />
            )}

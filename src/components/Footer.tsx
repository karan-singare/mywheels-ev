      ...
      <div className="px-6 md:px-[60px] py-16 md:py-20 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-white/10 hover:bg-[#0077B5] flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-14 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} MyWheels EV Pvt Ltd. All rights reserved.
          </p>
          <p className="text-white/40 text-sm italic">
            Powering Hyderabad's Mobility Future
          </p>
        </div>
      </div>
    </footer>

      ...
      <div className="relative z-10 px-6 md:px-[60px] py-20 md:py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#pricing"
              className="inline-flex items-center justify-center px-10 py-4 rounded-2xl font-semibold text-primary bg-white hover:bg-gray-50 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              View Plans
            </a>
            <a
              href="https://wa.me/919121969734?text=Hi%2C%20I%27m%20interested%20in%20renting%20an%20EV."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-2xl font-semibold text-white border-2 border-white/70 hover:bg-white/15 transition-all duration-300 hover:scale-105"
            >
